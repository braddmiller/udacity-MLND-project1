...
def explore_city_data(city_data):
    ...
    num_houses = len(housing_features)
    print "Number of Houses: " + str(num_houses)
    
    # Number of features?
    num_features = np.shape(housing_features)
    print "Number of Features: " + str(num_features[1])
    ...
    print "Price Standard Deviation: " + str(std_price)



## student defined function to analyze the data distribution
## Reference http://matplotlib.org/1.3.1/examples/pylab_examples/histogram_demo_extended.html for histogram
def plot_histogram(city_data):
    X, y = city_data.data, city_data.target

    n, bins, patches = pl.hist(y, 20, histtype='bar')
    #pl.setp(patches, 'facecolor', 'g', 'alpha', 0.75)
    pl.xlabel('Home Price ($10,000)')
    pl.ylabel('Number of Homes in Range')
    pl.show()
...
def performance_metric(label, prediction):
    ...
    mae = metrics.mean_absolute_error(label,prediction)
